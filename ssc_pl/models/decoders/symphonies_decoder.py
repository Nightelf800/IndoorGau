...
class SymphoniesDecoder(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv = nn.Conv3d(in_channels=128, out_channels=512, kernel_size=1, stride=1, padding=0)
    ...
    def forward(self, pred_insts, feats, pred_masks, depth, K, E, voxel_origin, projected_pix,
        ...
        # print(f'scene_embed.shape: {scene_embed.shape}')
        ...
        # print(f'scene_pos.shape: {scene_pos.shape}')
