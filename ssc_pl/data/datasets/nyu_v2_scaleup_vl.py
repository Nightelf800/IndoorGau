...
class NYUv2ScaleUpVL(Dataset):
    ...
    def __init__(self, split, data_root, data_scaleup_root, label_root, caption_root, voxel_size=0.08, pc_range=None, depth_root=None,
    ...
    def __getitem__(self, idx):
        ...
        # f = open('/data2/ylc/codes/IndoorGau/data/NYUv2/preprocess/base/NYUtrain/NYU0003_0000.pkl', 'rb'

        # 从caption_dict中获取caption
